...
export default function GroupsPage() {
    ...
    const DesktopActionButtons = () => (
        <div className="flex gap-2 mt-3">
            ...
            <button
                ...
                className="flex-1 bg-white text-primary border border-border-accent py-2.5 rounded-xl text-sm font-medium"
            >
                เข้าร่วมกลุ่ม
            </button>
        </div>
    ...
    const MobileActionButtons = () => (
        <div className="flex gap-3 mt-3">
            ...
            <button
                onClick={() => { setShowJoin(true); setShowCreate(false) }}
                className="flex-1 bg-white text-primary border border-border-accent py-4 rounded-2xl text-base font-medium"
            >
                เข้าร่วมกลุ่ม
            </button>
        </div>
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-gradient-lavender via-gradient-blush to-gradient-cream">
                    ...
                    >
                        ...
                        <form onSubmit={handleCreate} className="flex flex-col gap-3">
                            ...
                            <div className="flex gap-2 mt-2">
                                <button type="button" onClick={() => setShowCreate(false)} className="flex-1 bg-white text-primary border border-border-accent py-3 rounded-xl text-sm font-medium">ยกเลิก</button>
                ...
                >
                    ...
                    >
                        ...
                        <form onSubmit={handleJoin} className="flex flex-col gap-3">
                            ...
                            />
                            <div className="flex gap-2 mt-2">
                                <button type="button" onClick={() => setShowJoin(false)} className="flex-1 bg-white text-primary border border-border-accent py-3 rounded-xl text-sm font-medium">ยกเลิก</button>
            ...
            <div className="md:hidden flex flex-col min-h-screen">
                <div className="bg-linear-to-r from-gradient-lavender to-gradient-blush px-5 py-6 flex items-center justify-between">
                    <div>
                ...
                <div className="flex-1 flex items-center justify-center">
                    {selectedGroupId ? (
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-sm text-border-accent">เลือกกลุ่มเพื่อดูปฏิทิน</p>
                        </div>
                    )}
                </div>
            </div>
